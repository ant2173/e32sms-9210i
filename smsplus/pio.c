...
/* io_lut[2][256] and io_current now live in the heap state struct
   (sms_state.h) -- they were the last writable statics that crashed pio_init
   with KERN-EXEC 3 on EKA1. */
