...
/* Global variables -- moved to heap state struct (EKA1: no writable static
   data in a DLL). io_lut/io_current map into SMS_State() via sms_state.h. */
#ifndef SMS_STATE_DEFINING
#include "../smsplus/sms_state.h"
#endif
